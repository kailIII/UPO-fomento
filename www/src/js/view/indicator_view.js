...
//    	this.esIndicador = options.esIndicador;
    ...
    events: {
        ...
        "click #botonVerTabular": "goVerTabular",
        "click #botonVerGrafica": "goVerGrafica",
...
//    },
    ...
    goVerTabular: function(e) {
        if (!$(e.currentTarget).hasClass('down')) {
            $(e.currentTarget).toggleClass("down");
            $(e.currentTarget).siblings('a').toggleClass("down");
            $('.zonaIndicador').show();
            $('#zonaChart').hide();
        }
    },
    goVerGrafica: function(e) {
        if (!$(e.currentTarget).hasClass('down')) {
            $(e.currentTarget).toggleClass("down");
            $(e.currentTarget).siblings('a').toggleClass("down");
            $('.zonaIndicador').hide();
